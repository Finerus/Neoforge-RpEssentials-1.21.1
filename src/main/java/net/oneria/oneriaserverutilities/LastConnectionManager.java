...
public class LastConnectionManager {
    ...
    private static synchronized void ensureInitialized() {
        ...
        try {
            ...
            OneriaServerUtilities.LOGGER.info("[LastConnectionManager] Initialized - File: {}", dataFile.getAbsolutePath());
        } catch (Exception e) {
            OneriaServerUtilities.LOGGER.error("[LastConnectionManager] Failed to initialize", e);
        }
    }
            ...
            if (data != null) {
                ...
                for (Map.Entry<String, ConnectionEntry> e : data.entrySet()) {
                    try {
                        ...
                        OneriaServerUtilities.LOGGER.warn("[LastConnectionManager] Invalid UUID key: {}", e.getKey());
                    }
                }
                OneriaServerUtilities.LOGGER.info("[LastConnectionManager] Loaded {} entries", entries.size());
            }
        } catch (Exception e) {
            OneriaServerUtilities.LOGGER.error("[LastConnectionManager] Failed to load", e);
        }
    }
    ...
    private static void saveToFile() {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                OneriaServerUtilities.LOGGER.debug("[LastConnectionManager] Saved {} entries", snapshot.size());
            } catch (Exception e) {
                OneriaServerUtilities.LOGGER.error("[LastConnectionManager] Failed to save", e);
            }
        });
    }
